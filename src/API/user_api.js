...
export const Subscribe = async (ID) => {
  return await axios
    .post(`${process.env.REACT_APP_API_URL}/subscribe/`, { id: ID })
    .then((res) => {
...
export const Register = async (data) => {
  return await axios
    .post(`${process.env.REACT_APP_API_URL}/register`, data,{mode: 'no-cors'})
    .then((res) => {
      if (res.data !== "FAIL") {
        Swal.fire({
...
export const getUser = async (ID) => {
  await axios
    .post(`${process.env.REACT_APP_API_URL}/getUser/`, { id: ID })
    .then((res) => {
      return res.data;
      // setUser(res.data)
      // setLogin(true)
